      ...
      <div className="relative z-10 container mx-auto px-4 py-12 sm:py-16">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/80 max-w-xl md:max-w-2xl mx-auto">
            Choose the plan that works best for your legal practice. All plans include our core features with no hidden fees.
          </p>
        </motion.div>
            ...
            >
              ...
              {plan.popular && (
                <motion.div
                  ...
                  className="absolute top-4 right-4 bg-gradient-to-r from-blue-600 to-cyan-500 text-white text-xs font-bold px-3 py-1 rounded-full z-10 flex items-center"
                >
              ...
              <div className="bg-white/10 backdrop-blur-md p-6 h-full border border-white/20">
                ...
                <div className="relative inline-block mb-2">
                  ...
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-r from-blue-400/20 to-cyan-400/20 rounded"
                    initial={{ width: 0 }}
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={`w-full py-3 rounded-lg font-medium transition-all duration-300 text-white ${
                    plan.popular
        ...
        >
          ...
          <motion.div
            ...
            className="absolute top-6 left-6 w-12 h-12 bg-gradient-to-br from-blue-600 to-cyan-500 rounded-full flex items-center justify-center"
          >
          ...
          <div className="ml-16">
            {/* Shiny Text Title */}
            <div className="relative inline-block mb-2">
              <h3 className="text-lg sm:text-xl font-bold text-white">All plans include security guarantees</h3>
              <motion.div
                className="absolute inset-0 bg-gradient-to-r from-blue-400/20 to-cyan-400/20 rounded"
                initial={{ width: 0 }}
